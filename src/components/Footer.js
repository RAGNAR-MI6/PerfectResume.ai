    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">PerfectResume.ai</h3>
            <p className="text-gray-400 mb-4">
              Create the perfect resume in minutes with AI-powered tools that help you stand out and get hired faster.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} PerfectResume.ai. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
